...
| `rax` | general purpose register A | 32-bit general purpose register. Interpreted as an integer. Often used in `syscall`s. |
| `rbx` | general purpose register B | 32-bit general purpose register. Interpreted as a float. Often used in `syscall`s. |
